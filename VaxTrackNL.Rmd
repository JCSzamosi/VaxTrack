Vax Track Newfoundland
================

Tracking how quickly Newfoundland is moving its vaccine supply into human beings. All
...
theme_set(theme_bw())
library(lubridate)
url = 'https://api.covid19tracker.ca/reports/province/nl?fill_dates=true'
upd = fromJSON(url)
dat_can = upd$data
# head(dat_can)
# tail(dat_can)
...
msg = paste('So far Newfoundland has received ', 
