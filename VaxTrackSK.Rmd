Vax Track Saskatchewan
================

Tracking how quickly Saskatchewan is moving its vaccine supply into human beings. All
...
theme_set(theme_bw())
library(lubridate)
url = 'https://api.covid19tracker.ca/reports/province/sk?fill_dates=true'
upd = fromJSON(url)
dat_can = upd$data
# head(dat_can)
# tail(dat_can)
...
msg = paste('So far Saskatchewan has received ', 
